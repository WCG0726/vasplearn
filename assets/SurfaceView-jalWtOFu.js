...
<span class="fn2">print</span>(<span class="st">f&quot;层数: {slabgen._nlayers_slab}&quot;</span>)</code></pre>`,1))]),s[21]||(s[21]=n("h3",null,"4. INCAR 设置",-1)),n("div",w,[n("div",x,[s[12]||(s[12]=n("span",{class:"la"},"INCAR",-1)),s[13]||(s[13]=n("span",{class:"fn"},"表面优化",-1)),n("button",{class:"cpb",onClick:s[1]||(s[1]=(...t)=>a.copy&&a.copy(...t))},"复制")]),s[14]||(s[14]=o(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">Cu(111) surface</span>
...
<span class="kw">IDIPOL</span>   = <span class="nu">3</span>              <span class="cm">; z 方向校正</span></code></pre>`,1))]),s[22]||(s[22]=n("h3",null,"5. KPOINTS 设置",-1)),n("div",S,[n("div",I,[s[15]||(s[15]=n("span",{class:"la"},"KPOINTS",-1)),s[16]||(s[16]=n("span",{class:"fn"},"表面计算",-1)),n("button",{class:"cpb",onClick:s[2]||(s[2]=(...t)=>a.copy&&a.copy(...t))},"复制")]),s[17]||(s[17]=n("pre",null,[n("code",null,[p(`Automatic mesh
0
Gamma
12 12 1               `),n("span",{class:"cm"},"; z 方向设为 1"),p(`
0.0 0.0 0.0`)])],-1))]),s[23]||(s[23]=o('<div class="ib warn"><strong>重要：</strong>表面计算<strong>必须</strong>用 <code>ISIF=2</code>；KPOINTS z 方向设为 <code>1</code>；非对称 slab 开启偶极校正。</div><h3>6. 表面能计算</h3><div class="fb"><div class="fm">γ = (E_slab - N × E_bulk) / (2 × A)</div><div class="fd">γ: 表面能, A: 表面积, 2: 两个表面, N: slab 中的原子数</div></div>',3)),n("div",C,[n("div",N,[s[18]||(s[18]=n("span",{class:"la"},"python",-1)),n("button",{class:"cpb",onClick:s[3]||(s[3]=(...t)=>a.copy&&a.copy(...t))},"复制")]),s[19]||(s[19]=o(`<pre><code><span class="cm"># 计算表面能</span>
...
<span class="fn2">print</span>(<span class="st">f&quot;表面能: {gamma_Jm2:.2f} J/m²&quot;</span>)</code></pre>`,1))])])}const P=i(v,[["render",E]]);export{P as default};
