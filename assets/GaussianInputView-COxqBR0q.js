import{_ as i,o as m,c as u,a,e as r,w as e,h as d,f as c,g as v}from"./index-Bd4xWfQT.js";const h={name:"GaussianInputView",methods:{copy(p){const l=p.target.closest(".cb").querySelector("pre").textContent;navigator.clipboard.writeText(l).then(()=>{p.target.textContent="已复制!",p.target.classList.add("ok"),setTimeout(()=>{p.target.textContent="复制",p.target.classList.remove("ok")},2e3)})}}},b={class:"sec active"},f={class:"bread"},k={class:"cb"},y={class:"ch"},g={class:"cb"},G={class:"ch"},B={class:"cb"},H={class:"ch"},C={class:"cb"},x={class:"ch"},T={class:"cb"},L={class:"ch"};function O(p,s,l,q,P,n){const o=v("router-link");return m(),u("div",b,[a("div",f,[r(o,{to:"/"},{default:e(()=>[...s[5]||(s[5]=[d("首页",-1)])]),_:1}),s[7]||(s[7]=d("/ ",-1)),r(o,{to:"/gaussian"},{default:e(()=>[...s[6]||(s[6]=[d("Gaussian 教程",-1)])]),_:1}),s[8]||(s[8]=d("/ ",-1)),s[9]||(s[9]=a("span",null,"输入文件",-1))]),s[21]||(s[21]=a("h2",null,"Gaussian 输入文件详解",-1)),s[22]||(s[22]=a("p",null,"Gaussian 输入文件（.gjf 或 .com）包含计算的所有设置信息。",-1)),s[23]||(s[23]=a("h3",null,"1. 输入文件结构",-1)),a("div",k,[a("div",y,[s[10]||(s[10]=a("span",{class:"la"},"input.gjf",-1)),s[11]||(s[11]=a("span",{class:"fn"},"完整结构",-1)),a("button",{class:"cpb",onClick:s[0]||(s[0]=(...t)=>n.copy&&n.copy(...t))},"复制")]),s[12]||(s[12]=c(`<pre><code><span class="cm">%chk=molecule.chk</span>           <span class="cm">; 检查点文件</span>
...
<span class="vr">H</span>   <span class="nu">0.000000  -0.757200  -0.469200</span>
                              ...
                              <span class="cm">; 空行结束</span></code></pre>`,1))]),s[24]||(s[24]=c(`<h3>2. 路由段详解</h3><p>路由段以 <code class="ic">#</code> 开头，指定计算方法和任务类型。</p><h4>基本格式</h4><div class="cb"><div class="ch"><span class="la">格式</span></div><pre><code><span class="cm"># [选项] 方法/基组 [任务关键词] [其他选项]</span>
...
<span class="vr">H</span>  <span class="nu">1</span>  <span class="nu">0.96</span>  <span class="nu">2</span>  <span class="nu">104.5</span></code></pre></div><h3>5. 常用输入模板</h3><h4>模板 1：几何优化 + 频率</h4>`,18)),a("div",g,[a("div",G,[s[13]||(s[13]=a("span",{class:"la"},"opt_freq.gjf",-1)),a("button",{class:"cpb",onClick:s[1]||(s[1]=(...t)=>n.copy&&n.copy(...t))},"复制")]),s[14]||(s[14]=c(`<pre><code><span class="cm">%chk=molecule.chk</span>
...
<span class="cm">[原子坐标]</span></code></pre>`,1))]),s[25]||(s[25]=a("h4",null,"模板 2：过渡态搜索",-1)),a("div",B,[a("div",H,[s[15]||(s[15]=a("span",{class:"la"},"ts_search.gjf",-1)),a("button",{class:"cpb",onClick:s[2]||(s[2]=(...t)=>n.copy&&n.copy(...t))},"复制")]),s[16]||(s[16]=c(`<pre><code><span class="cm">%chk=ts.chk</span>
...
<span class="nu">0 1</span>
<span class="cm">[过渡态坐标]</span></code></pre>`,1))]),s[26]||(s[26]=a("h4",null,"模板 3：TDDFT 激发态",-1)),a("div",C,[a("div",x,[s[17]||(s[17]=a("span",{class:"la"},"tddft.gjf",-1)),a("button",{class:"cpb",onClick:s[3]||(s[3]=(...t)=>n.copy&&n.copy(...t))},"复制")]),s[18]||(s[18]=c(`<pre><code><span class="cm">%chk=tddft.chk</span>
<span class="cm">%mem=16GB</span>
<span class="cm">%nproc=8</span>
...
<span class="nu">0 1</span>
<span class="cm">[分子坐标]</span></code></pre>`,1))]),s[27]||(s[27]=a("h4",null,"模板 4：高精度单点能",-1)),a("div",T,[a("div",L,[s[19]||(s[19]=a("span",{class:"la"},"high_accuracy.gjf",-1)),a("button",{class:"cpb",onClick:s[4]||(s[4]=(...t)=>n.copy&&n.copy(...t))},"复制")]),s[20]||(s[20]=c(`<pre><code><span class="cm">%chk=ccsdt.chk</span>
...
<span class="nu">0 1</span>
<span class="cm">[优化后的坐标]</span></code></pre>`,1))]),s[28]||(s[28]=c(`<h3>6. 特殊设置</h3><h4>对称性限制</h4><div class="cb"><div class="ch"><span class="la">对称性</span></div><pre><code><span class="cm"># 强制 C2v 对称性</span>
