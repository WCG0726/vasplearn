...
<span class="fn2">grep</span> -i <span class="st">&quot;error\\|warning\\|abort&quot;</span> OUTCAR</code></pre>`,1))]),t[19]||(t[19]=d("h3",null,"6. 常见计算任务 INCAR 模板",-1)),t[20]||(t[20]=d("h4",null,"结构优化",-1)),d("div",N,[d("div",k,[t[9]||(t[9]=d("span",{class:"la"},"INCAR",-1)),t[10]||(t[10]=d("span",{class:"fn"},"体相优化",-1)),d("button",{class:"cpb",onClick:t[1]||(t[1]=(...a)=>s.copy&&s.copy(...a))},"复制")]),t[11]||(t[11]=p(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">Bulk optimization</span>
...
<span class="kw">SIGMA</span>    = <span class="nu">0.05</span></code></pre>`,1))]),t[21]||(t[21]=d("h4",null,"态密度计算",-1)),d("div",S,[d("div",T,[t[12]||(t[12]=d("span",{class:"la"},"INCAR",-1)),t[13]||(t[13]=d("span",{class:"fn"},"DOS",-1)),d("button",{class:"cpb",onClick:t[2]||(t[2]=(...a)=>s.copy&&s.copy(...a))},"复制")]),t[14]||(t[14]=p(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">DOS calculation</span>
<span class="kw">ENCUT</span>    = <span class="nu">400</span>
<span class="kw">PREC</span>     = <span class="st">Accurate</span>
<span class="kw">EDIFF</span>    = <span class="nu">1E-6</span>
...
<span class="kw">LWAVE</span>    = <span class="nu">.TRUE.</span>        <span class="cm">; 保留波函数</span></code></pre>`,1))]),t[22]||(t[22]=d("h4",null,"能带计算",-1)),d("div",O,[d("div",m,[t[15]||(t[15]=d("span",{class:"la"},"INCAR",-1)),t[16]||(t[16]=d("span",{class:"fn"},"Band structure",-1)),d("button",{class:"cpb",onClick:t[3]||(t[3]=(...a)=>s.copy&&s.copy(...a))},"复制")]),t[17]||(t[17]=p(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">Band structure</span>
<span class="kw">ENCUT</span>    = <span class="nu">400</span>
<span class="kw">PREC</span>     = <span class="st">Accurate</span>
