import{_ as A,o as d,c,a,F as i,b as u,i as S,t as o,d as m,f as l,e as I,w as C,h as v,g as w}from"./index-Bd4xWfQT.js";const f={name:"QuickRef",data(){return{activeTab:"incar",tabs:[{id:"incar",name:"INCAR"},{id:"ismear",name:"ISMEAR"},{id:"ibrion",name:"IBRION"},{id:"isif",name:"ISIF"}],incarParams:[{name:"ENCUT",desc:"平面波截断能",value:"400-600 eV"},{name:"EDIFF",desc:"电子步收敛标准",value:"1E-6"},{name:"EDIFFG",desc:"离子步收敛标准",value:"-0.02 eV/Å"},{name:"PREC",desc:"计算精度",value:"Accurate"},{name:"NSW",desc:"最大离子步数",value:"100-200"},{name:"NELM",desc:"最大电子步数",value:"60-200"},{name:"NBANDS",desc:"能带数目",value:"auto 或 NELECT/2+N"},{name:"LREAL",desc:"实空间投影",value:"Auto (>50原子)"}],ismearParams:[{value:"-5",method:"四面体法",use:"绝缘体/半导体 DOS",sigma:"自动"},{value:"-4",method:"四面体+Blochl",use:"金属 DOS",sigma:"自动"},{value:"0",method:"Gaussian",use:"半导体/绝缘体",sigma:"0.05"},{value:"1",method:"MP 展宽",use:"金属",sigma:"0.2"},{value:"2",method:"MP 改进",use:"金属 (更平滑)",sigma:"0.2"}],ibrionParams:[{value:"-1",method:"不动",desc:"静态计算或 MD"},{value:"0",method:"MD",desc:"分子动力学"},{value:"1",method:"RMM-DIIS",desc:"准牛顿法 (推荐)"},{value:"2",method:"CG",desc:"共轭梯度法"},{value:"3",method:"Damped MD",desc:"阻尼分子动力学"}],isifParams:[{value:"2",optimize:"仅离子位置",use:"表面计算、分子吸附"},{value:"3",optimize:"离子+晶格(体积+形状)",use:"体相优化 (最常用)"},{value:"4",optimize:"离子+晶格形状",use:"固定体积优化"},{value:"5",optimize:"仅晶格(体积+形状)",use:"固定离子"},{value:"6",optimize:"仅晶格形状",use:"固定体积+离子"},{value:"7",optimize:"仅晶格体积",use:"固定形状+离子"}]}}},R={class:"quick-ref"},T={class:"ref-tabs"},P=["onClick"],O={class:"ref-content"},N={key:0,class:"ref-table"},y={class:"ref-cell code"},F={class:"ref-cell"},M={class:"ref-cell code"},D={key:1,class:"ref-table"},g={class:"ref-cell code"},h={class:"ref-cell"},L={class:"ref-cell"},G={class:"ref-cell code"},U={key:2,class:"ref-table"},B={class:"ref-cell code"},V={class:"ref-cell"},W={class:"ref-cell"},K={key:3,class:"ref-table"},x={class:"ref-cell code"},z={class:"ref-cell"},X={class:"ref-cell"};function H(r,s,k,E,e,n){return d(),c("div",R,[s[4]||(s[4]=a("h3",null,"快速参考",-1)),a("div",T,[(d(!0),c(i,null,u(e.tabs,t=>(d(),c("button",{key:t.id,class:S(["ref-tab",{active:e.activeTab===t.id}]),onClick:b=>e.activeTab=t.id},o(t.name),11,P))),128))]),a("div",O,[e.activeTab==="incar"?(d(),c("div",N,[s[0]||(s[0]=a("div",{class:"ref-row header"},[a("div",{class:"ref-cell"},"参数"),a("div",{class:"ref-cell"},"说明"),a("div",{class:"ref-cell"},"常用值")],-1)),(d(!0),c(i,null,u(e.incarParams,t=>(d(),c("div",{key:t.name,class:"ref-row"},[a("div",y,o(t.name),1),a("div",F,o(t.desc),1),a("div",M,o(t.value),1)]))),128))])):m("",!0),e.activeTab==="ismear"?(d(),c("div",D,[s[1]||(s[1]=l('<div class="ref-row header" data-v-b684b753><div class="ref-cell" data-v-b684b753>ISMEAR</div><div class="ref-cell" data-v-b684b753>方法</div><div class="ref-cell" data-v-b684b753>适用场景</div><div class="ref-cell" data-v-b684b753>SIGMA</div></div>',1)),(d(!0),c(i,null,u(e.ismearParams,t=>(d(),c("div",{key:t.value,class:"ref-row"},[a("div",g,o(t.value),1),a("div",h,o(t.method),1),a("div",L,o(t.use),1),a("div",G,o(t.sigma),1)]))),128))])):m("",!0),e.activeTab==="ibrion"?(d(),c("div",U,[s[2]||(s[2]=a("div",{class:"ref-row header"},[a("div",{class:"ref-cell"},"IBRION"),a("div",{class:"ref-cell"},"方法"),a("div",{class:"ref-cell"},"说明")],-1)),(d(!0),c(i,null,u(e.ibrionParams,t=>(d(),c("div",{key:t.value,class:"ref-row"},[a("div",B,o(t.value),1),a("div",V,o(t.method),1),a("div",W,o(t.desc),1)]))),128))])):m("",!0),e.activeTab==="isif"?(d(),c("div",K,[s[3]||(s[3]=a("div",{class:"ref-row header"},[a("div",{class:"ref-cell"},"ISIF"),a("div",{class:"ref-cell"},"优化内容"),a("div",{class:"ref-cell"},"适用场景")],-1)),(d(!0),c(i,null,u(e.isifParams,t=>(d(),c("div",{key:t.value,class:"ref-row"},[a("div",x,o(t.value),1),a("div",z,o(t.optimize),1),a("div",X,o(t.use),1)]))),128))])):m("",!0)])])}const Y=A(f,[["render",H],["__scopeId","data-v-b684b753"]]),q={name:"InputView",components:{QuickRef:Y},methods:{copy(r){const k=r.target.closest(".cb").querySelector("pre").textContent;navigator.clipboard.writeText(k).then(()=>{r.target.textContent="已复制!",r.target.classList.add("ok"),setTimeout(()=>{r.target.textContent="复制",r.target.classList.remove("ok")},2e3)})}}},Q={class:"sec active"},J={class:"bread"},Z={class:"cb"},j={class:"ch"},$={class:"cb"},_={class:"ch"},ss={class:"cb"},as={class:"ch"},ns={class:"cb"},ps={class:"ch"},ts={class:"cb"},ls={class:"ch"},ds={class:"cb"},cs={class:"ch"},os={class:"cb"},es={class:"ch"},rs={class:"cb"},is={class:"ch"},us={class:"cb"},ms={class:"ch"},vs={class:"cb"},ks={class:"ch"},bs={class:"cb"},Is={class:"ch"},ws={class:"cb"},As={class:"ch"},Es={class:"cb"},Ss={class:"ch"},Cs={class:"cb"},fs={class:"ch"},Rs={class:"cb"},Ts={class:"ch"},Ps={class:"cb"},Os={class:"ch"},Ns={class:"cb"},ys={class:"ch"};function Fs(r,s,k,E,e,n){const t=w("router-link"),b=w("QuickRef");return d(),c("div",Q,[a("div",J,[I(t,{to:"/"},{default:C(()=>[...s[17]||(s[17]=[v("首页",-1)])]),_:1}),s[18]||(s[18]=v("/",-1)),s[19]||(s[19]=a("span",null,"输入文件",-1))]),s[69]||(s[69]=l('<h2>VASP 输入文件总览</h2><p>VASP 需要 <strong>4 个核心输入文件</strong>，正确设置这些文件是成功计算的基础。</p><div class="ft"><div class="ft-i"><span style="color:var(--blue);">📄</span> INCAR — 控制参数（告诉 VASP 做什么）</div><div class="ft-i"><span style="color:var(--green);">📄</span> POSCAR — 晶体结构（告诉 VASP 计算什么）</div><div class="ft-i"><span style="color:var(--purple);">📄</span> KPOINTS — k 点网格（控制精度）</div><div class="ft-i"><span style="color:var(--red);">📄</span> POTCAR — 赝势文件（定义元素）</div></div><div class="ib warn"><strong>注意：</strong>POTCAR 中元素的顺序必须与 POSCAR 中的元素顺序一致！</div>',4)),I(b),s[70]||(s[70]=a("h2",null,"INCAR 文件详解",-1)),s[71]||(s[71]=a("p",null,"INCAR 是 VASP 最核心的控制文件，决定计算类型和精度。",-1)),s[72]||(s[72]=a("h3",null,"1. 基本结构",-1)),a("div",Z,[a("div",j,[s[20]||(s[20]=a("span",{class:"la"},"INCAR",-1)),s[21]||(s[21]=a("span",{class:"fn"},"结构优化示例",-1)),a("button",{class:"cpb",onClick:s[0]||(s[0]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[22]||(s[22]=l(`<pre><code><span class="cm"># 注释以 # 或 ; 开头</span>
...
<span class="kw">NCORE</span>    = <span class="nu">16</span>               <span class="cm">; 每节点核心数</span></code></pre>`,1))]),s[74]||(s[74]=a("h3",null,"9. 性能优化参数",-1)),a("div",ss,[a("div",as,[s[26]||(s[26]=a("span",{class:"la"},"INCAR",-1)),s[27]||(s[27]=a("span",{class:"fn"},"大体系优化",-1)),a("button",{class:"cpb",onClick:s[2]||(s[2]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[28]||(s[28]=l(`<pre><code><span class="cm"># 实空间投影（&gt;50 原子推荐）</span>
...
<span class="kw">NWRITE</span>   = <span class="nu">0</span>                <span class="cm">; 减少输出</span></code></pre>`,1))]),s[75]||(s[75]=a("h2",null,"POSCAR 文件详解",-1)),s[76]||(s[76]=a("p",null,"POSCAR 定义晶体结构，包括晶格和原子坐标。",-1)),s[77]||(s[77]=a("h3",null,"1. 完整格式",-1)),a("div",ns,[a("div",ps,[s[29]||(s[29]=a("span",{class:"la"},"POSCAR",-1)),s[30]||(s[30]=a("span",{class:"fn"},"格式详解",-1)),a("button",{class:"cpb",onClick:s[3]||(s[3]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[31]||(s[31]=l(`<pre><code><span class="vr">Si diamond</span>                    <span class="cm">; 第 1 行：注释（任意文字）</span>
...
<span class="nu">0.25  0.25  0.25</span></code></pre>`,1))]),s[78]||(s[78]=l('<h3>2. 坐标类型</h3><table class="tb"><thead><tr><th>类型</th><th>关键字</th><th>格式</th><th>适用场景</th></tr></thead><tbody><tr><td>分数坐标</td><td><code>Direct</code></td><td>0~1</td><td>最常用</td></tr><tr><td>笛卡尔坐标</td><td><code>Cartesian</code></td><td>Å</td><td>分子/团簇</td></tr></tbody></table><h3>3. 选择性动力学</h3><p>允许固定部分原子，常用于表面计算。</p>',4)),a("div",ts,[a("div",ls,[s[32]||(s[32]=a("span",{class:"la"},"POSCAR",-1)),s[33]||(s[33]=a("span",{class:"fn"},"选择性动力学",-1)),a("button",{class:"cpb",onClick:s[4]||(s[4]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[34]||(s[34]=l(`<pre><code><span class="vr">Si surface</span>
...
<span class="nu">0.75  0.75  0.75</span>  <span class="st">T T T</span>   <span class="cm">; 可动层</span></code></pre>`,1))]),s[79]||(s[79]=a("h3",null,"4. 多元素体系",-1)),a("div",ds,[a("div",cs,[s[35]||(s[35]=a("span",{class:"la"},"POSCAR",-1)),s[36]||(s[36]=a("span",{class:"fn"},"TiO2 示例",-1)),a("button",{class:"cpb",onClick:s[5]||(s[5]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[37]||(s[37]=l(`<pre><code><span class="vr">TiO2 rutile</span>
<span class="nu">1.0</span>
...
<span class="nu">0.20  0.80  0.50</span>             <span class="cm">; O 原子 4</span></code></pre>`,1))]),s[80]||(s[80]=a("div",{class:"ib warn"},[a("strong",null,"重要："),v("POSCAR 中元素顺序必须与 POTCAR 一致！")],-1)),s[81]||(s[81]=a("h2",null,"KPOINTS 文件详解",-1)),s[82]||(s[82]=a("p",null,"KPOINTS 定义倒空间采样网格，控制计算精度。",-1)),s[83]||(s[83]=a("h3",null,"1. 自动网格模式（最常用）",-1)),a("div",os,[a("div",es,[s[38]||(s[38]=a("span",{class:"la"},"KPOINTS",-1)),s[39]||(s[39]=a("span",{class:"fn"},"Gamma 中心",-1)),a("button",{class:"cpb",onClick:s[6]||(s[6]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[40]||(s[40]=l(`<pre><code><span class="vr">Automatic mesh</span>               <span class="cm">; 注释行</span>
...
<span class="nu">0.0  0.0  0.0</span>                <span class="cm">; 偏移量</span></code></pre>`,1))]),s[84]||(s[84]=a("h3",null,"2. Monkhorst-Pack 网格",-1)),a("div",rs,[a("div",is,[s[41]||(s[41]=a("span",{class:"la"},"KPOINTS",-1)),s[42]||(s[42]=a("span",{class:"fn"},"Monkhorst-Pack",-1)),a("button",{class:"cpb",onClick:s[7]||(s[7]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[43]||(s[43]=l(`<pre><code><span class="vr">Monkhorst-Pack mesh</span>
<span class="nu">0</span>
<span class="kw">Monkhorst</span>                     <span class="cm">; MP 网格（与 Gamma 不同偏移）</span>
<span class="nu">4  4  4</span>
<span class="nu">0.5  0.5  0.5</span>                <span class="cm">; 偏移 0.5</span></code></pre>`,1))]),s[85]||(s[85]=a("h3",null,"3. Line-mode（能带计算）",-1)),a("div",us,[a("div",ms,[s[44]||(s[44]=a("span",{class:"la"},"KPOINTS",-1)),s[45]||(s[45]=a("span",{class:"fn"},"Line-mode",-1)),a("button",{class:"cpb",onClick:s[8]||(s[8]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[46]||(s[46]=l(`<pre><code><span class="vr">k-points along high symmetry lines</span>
...
&quot;</code></pre>`,1))]),s[87]||(s[87]=a("h3",null,"4. 检查 POTCAR",-1)),a("div",bs,[a("div",Is,[s[49]||(s[49]=a("span",{class:"la"},"bash",-1)),a("button",{class:"cpb",onClick:s[10]||(s[10]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[50]||(s[50]=l(`<pre><code><span class="cm"># 查看元素</span>
...
<span class="fn2">grep</span> TITEL POTCAR <span class="cm"># 查看 POTCAR 元素</span></code></pre>`,1))]),s[88]||(s[88]=a("h2",null,"常用 INCAR 模板",-1)),s[89]||(s[89]=a("h3",null,"1. 金属结构优化",-1)),a("div",ws,[a("div",As,[s[51]||(s[51]=a("span",{class:"la"},"INCAR",-1)),s[52]||(s[52]=a("span",{class:"fn"},"金属优化",-1)),a("button",{class:"cpb",onClick:s[11]||(s[11]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[53]||(s[53]=l(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">Metal relaxation</span>
...
<span class="kw">SIGMA</span>    = <span class="nu">0.2</span>               <span class="cm">; 较大的展宽</span></code></pre>`,1))]),s[90]||(s[90]=a("h3",null,"2. 绝缘体 DOS 计算",-1)),a("div",Es,[a("div",Ss,[s[54]||(s[54]=a("span",{class:"la"},"INCAR",-1)),s[55]||(s[55]=a("span",{class:"fn"},"DOS",-1)),a("button",{class:"cpb",onClick:s[12]||(s[12]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[56]||(s[56]=l(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">Insulator DOS</span>
<span class="kw">ENCUT</span>    = <span class="nu">400</span>
<span class="kw">PREC</span>     = <span class="st">Accurate</span>
<span class="kw">EDIFF</span>    = <span class="nu">1E-6</span>
...
<span class="kw">NEDOS</span>    = <span class="nu">2000</span>             <span class="cm">; DOS 能量点数</span></code></pre>`,1))]),s[91]||(s[91]=a("h3",null,"3. 表面计算",-1)),a("div",Cs,[a("div",fs,[s[57]||(s[57]=a("span",{class:"la"},"INCAR",-1)),s[58]||(s[58]=a("span",{class:"fn"},"表面优化",-1)),a("button",{class:"cpb",onClick:s[13]||(s[13]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[59]||(s[59]=l(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">Surface optimization</span>
...
<span class="kw">IDIPOL</span>   = <span class="nu">3</span>                <span class="cm">; z 方向校正</span></code></pre>`,1))]),s[92]||(s[92]=a("h3",null,"4. 磁性计算",-1)),a("div",Rs,[a("div",Ts,[s[60]||(s[60]=a("span",{class:"la"},"INCAR",-1)),s[61]||(s[61]=a("span",{class:"fn"},"磁性优化",-1)),a("button",{class:"cpb",onClick:s[14]||(s[14]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[62]||(s[62]=l(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">Magnetic calculation</span>
<span class="kw">ENCUT</span>    = <span class="nu">400</span>
<span class="kw">PREC</span>     = <span class="st">Accurate</span>
<span class="kw">EDIFF</span>    = <span class="nu">1E-6</span>
<span class="kw">IBRION</span>   = <span class="nu">2</span>
...
<span class="kw">SIGMA</span>    = <span class="nu">0.2</span></code></pre>`,1))]),s[93]||(s[93]=a("h3",null,"5. DFT+U 计算",-1)),a("div",Ps,[a("div",Os,[s[63]||(s[63]=a("span",{class:"la"},"INCAR",-1)),s[64]||(s[64]=a("span",{class:"fn"},"DFT+U",-1)),a("button",{class:"cpb",onClick:s[15]||(s[15]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[65]||(s[65]=l(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">DFT+U calculation</span>
<span class="kw">ENCUT</span>    = <span class="nu">400</span>
<span class="kw">PREC</span>     = <span class="st">Accurate</span>
<span class="kw">EDIFF</span>    = <span class="nu">1E-6</span>
<span class="kw">IBRION</span>   = <span class="nu">2</span>
...
<span class="kw">SIGMA</span>    = <span class="nu">0.05</span></code></pre>`,1))]),s[94]||(s[94]=a("h3",null,"6. 杂化泛函 (HSE06)",-1)),a("div",Ns,[a("div",ys,[s[66]||(s[66]=a("span",{class:"la"},"INCAR",-1)),s[67]||(s[67]=a("span",{class:"fn"},"HSE06",-1)),a("button",{class:"cpb",onClick:s[16]||(s[16]=(...p)=>n.copy&&n.copy(...p))},"复制")]),s[68]||(s[68]=l(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">HSE06 calculation</span>
<span class="kw">ENCUT</span>    = <span class="nu">400</span>
<span class="kw">PREC</span>     = <span class="st">Accurate</span>
<span class="kw">EDIFF</span>    = <span class="nu">1E-6</span>
<span class="kw">IBRION</span>   = <span class="nu">-1</span>
...
<span class="kw">ISMEAR</span>   = <span class="nu">0</span>
<span class="kw">SIGMA</span>    = <span class="nu">0.05</span></code></pre>`,1))]),s[95]||(s[95]=a("div",{class:"ib warn"},[a("strong",null,"注意："),v("HSE06 计算量约为 PBE 的 10-100 倍，需要足够的计算资源。")],-1))])}const Ds=A(q,[["render",Fs]]);export{Ds as default};
