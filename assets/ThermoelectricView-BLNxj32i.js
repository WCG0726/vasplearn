import{_ as i,o as r,c as m,a as n,e as u,w as e,h as t,f as l,g as k}from"./index-Bd4xWfQT.js";const f={name:"ThermoelectricView",methods:{copy(c){const d=c.target.closest(".cb").querySelector("pre").textContent;navigator.clipboard.writeText(d).then(()=>{c.target.textContent="已复制!",c.target.classList.add("ok"),setTimeout(()=>{c.target.textContent="复制",c.target.classList.remove("ok")},2e3)})}}},T={class:"sec active"},b={class:"bread"},S={class:"cb"},v={class:"ch"},E={class:"cb"},w={class:"ch"},C={class:"cb"},g={class:"ch"},R={class:"cb"},I={class:"ch"},A={class:"cb"},B={class:"ch"},y={class:"cb"},P={class:"ch"},N={class:"cb"},K={class:"ch"},O={class:"cb"},F={class:"ch"},x={class:"cb"},z={class:"ch"},V={class:"cb"},Z={class:"ch"},q={class:"cb"},D={class:"ch"};function W(c,s,d,M,U,a){const o=k("router-link");return r(),m("div",T,[n("div",b,[u(o,{to:"/"},{default:e(()=>[...s[11]||(s[11]=[t("首页",-1)])]),_:1}),s[13]||(s[13]=t("/ ",-1)),u(o,{to:"/tasks"},{default:e(()=>[...s[12]||(s[12]=[t("计算任务",-1)])]),_:1}),s[14]||(s[14]=t("/ ",-1)),s[15]||(s[15]=n("span",null,"热电计算",-1))]),s[47]||(s[47]=l('<h2>热电材料计算</h2><p>热电材料能够将热能直接转换为电能（Seebeck效应）或将电能转换为热能（Peltier效应），在废热回收和固态制冷中有重要应用。</p><h3>1. 热电优值 ZT</h3><p>热电材料的性能由无量纲热电优值 ZT 表征：</p><div class="fb"><div class="fm">ZT = S²σT / κ</div><div class="fd">S: Seebeck系数 | σ: 电导率 | T: 温度 | κ: 热导率</div></div><table class="tb"><thead><tr><th>参数</th><th>单位</th><th>理想方向</th><th>说明</th></tr></thead><tbody><tr><td><strong>Seebeck系数 S</strong></td><td>μV/K</td><td>越大越好</td><td>衡量每单位温差产生的电压</td></tr><tr><td><strong>电导率 σ</strong></td><td>S/m</td><td>越大越好</td><td>衡量电荷传输能力</td></tr><tr><td><strong>热导率 κ</strong></td><td>W/m·K</td><td>越小越好</td><td>κ = κ<sub>e</sub> + κ<sub>l</sub></td></tr><tr><td><strong>功率因子 PF</strong></td><td>μW/cm·K²</td><td>越大越好</td><td>PF = S²σ</td></tr></tbody></table><div class="ib tip"><strong>ZT 目标：</strong>商业化应用需要 ZT &gt; 2.0，目前最佳热电材料（如 SnSe）在高温下可达 ZT ~ 2.6。</div><h3>2. 计算流程</h3><div class="fc"><div class="fn2-node s">结构优化（获取稳定结构）</div><div class="fa"></div><div class="fn2-node p">自洽计算（获取精确电荷密度）</div><div class="fa"></div><div class="fn2-node p">非自洽计算（密集 K 点，获取能带）</div><div class="fa"></div><div class="fn2-node p">BoltzTraP 计算输运性质</div><div class="fa"></div><div class="fn2-node p">声子计算（获取晶格热导率）</div><div class="fa"></div><div class="fn2-node e">计算 ZT 值</div></div><h3>3. 结构优化</h3>',10)),n("div",S,[n("div",v,[s[16]||(s[16]=n("span",{class:"la"},"INCAR",-1)),s[17]||(s[17]=n("span",{class:"fn"},"热电材料结构优化",-1)),n("button",{class:"cpb",onClick:s[0]||(s[0]=(...p)=>a.copy&&a.copy(...p))},"复制")]),s[18]||(s[18]=l(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">Bi2Te3 relaxation</span>
...
<span class="kw">NBANDS</span>   = <span class="nu">200</span>              <span class="cm">; SOC 需要更多能带</span></code></pre>`,1))]),s[48]||(s[48]=n("h3",null,"4. 自洽计算",-1)),n("div",E,[n("div",w,[s[19]||(s[19]=n("span",{class:"la"},"INCAR",-1)),s[20]||(s[20]=n("span",{class:"fn"},"自洽计算",-1)),n("button",{class:"cpb",onClick:s[1]||(s[1]=(...p)=>a.copy&&a.copy(...p))},"复制")]),s[21]||(s[21]=l(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">Bi2Te3 SCF</span>
...
<span class="kw">LCHARG</span>   = <span class="nu">.TRUE.</span></code></pre>`,1))]),s[49]||(s[49]=n("h3",null,"5. 非自洽计算（密集 K 点）",-1)),s[50]||(s[50]=n("p",null,"BoltzTraP 需要非常密集的 K 点网格来准确计算输运性质。",-1)),n("div",C,[n("div",g,[s[22]||(s[22]=n("span",{class:"la"},"INCAR",-1)),s[23]||(s[23]=n("span",{class:"fn"},"非自洽计算",-1)),n("button",{class:"cpb",onClick:s[2]||(s[2]=(...p)=>a.copy&&a.copy(...p))},"复制")]),s[24]||(s[24]=l(`<pre><code><span class="kw">SYSTEM</span>   = <span class="st">Bi2Te3 non-SCF</span>
...
<span class="kw">NEDOS</span>    = <span class="nu">2000</span></code></pre>`,1))]),n("div",R,[n("div",I,[s[25]||(s[25]=n("span",{class:"la"},"KPOINTS",-1)),s[26]||(s[26]=n("span",{class:"fn"},"密集网格（BoltzTraP 需要）",-1)),n("button",{class:"cpb",onClick:s[3]||(s[3]=(...p)=>a.copy&&a.copy(...p))},"复制")]),s[27]||(s[27]=l(`<pre><code><span class="vr">Dense k-mesh for BoltzTraP</span>
<span class="nu">0</span>
<span class="kw">Gamma</span>
<span class="nu">24  24  24</span>               <span class="cm">; 非常密集的 K 点</span>
<span class="nu">0.0  0.0  0.0</span></code></pre>`,1))]),s[51]||(s[51]=n("div",{class:"ib warn"},[n("strong",null,"重要："),t("BoltzTraP 需要非常密集的 K 点（通常 20×20×20 或更高），否则输运系数不准确。")],-1)),s[52]||(s[52]=n("h3",null,"6. BoltzTraP 计算",-1)),s[53]||(s[53]=n("p",null,"BoltzTraP 基于玻尔兹曼输运理论计算电导率和 Seebeck 系数。",-1)),s[54]||(s[54]=n("h4",null,"安装 BoltzTraP",-1)),n("div",A,[n("div",B,[s[28]||(s[28]=n("span",{class:"la"},"bash",-1)),n("button",{class:"cpb",onClick:s[4]||(s[4]=(...p)=>a.copy&&a.copy(...p))},"复制")]),s[29]||(s[29]=l(`<pre><code><span class="cm"># 下载 BoltzTraP</span>
...
<span class="fn2">cp</span> boltztrap ../bin/</code></pre>`,1))]),s[55]||(s[55]=n("h4",null,"运行 BoltzTraP",-1)),n("div",y,[n("div",P,[s[30]||(s[30]=n("span",{class:"la"},"bash",-1)),s[31]||(s[31]=n("span",{class:"fn"},"boltztrap.sh",-1)),n("button",{class:"cpb",onClick:s[5]||(s[5]=(...p)=>a.copy&&a.copy(...p))},"复制")]),s[32]||(s[32]=l(`<pre><code><span class="kw">#!/bin/bash</span>
...
<span class="cm"># 输出文件：bi2te3.trace (Seebeck, 电导率等)</span></code></pre>`,1))]),s[56]||(s[56]=n("h4",null,"解读 BoltzTraP 输出",-1)),n("div",N,[n("div",K,[s[33]||(s[33]=n("span",{class:"la"},"python",-1)),s[34]||(s[34]=n("span",{class:"fn"},"read_boltztrap.py",-1)),n("button",{class:"cpb",onClick:s[6]||(s[6]=(...p)=>a.copy&&a.copy(...p))},"复制")]),s[35]||(s[35]=l(`<pre><code><span class="kw">import</span> numpy <span class="kw">as</span> np
...
plt.show()</code></pre>`,1))]),s[57]||(s[57]=n("h3",null,"7. 晶格热导率计算",-1)),s[58]||(s[58]=n("p",null,[t("晶格热导率 κ"),n("sub",null,"l"),t(" 通过声子计算获得，使用 Slack 模型或求解玻尔兹曼方程。")],-1)),s[59]||(s[59]=n("h4",null,"Slack 模型估算",-1)),n("div",O,[n("div",F,[s[36]||(s[36]=n("span",{class:"la"},"python",-1)),s[37]||(s[37]=n("span",{class:"fn"},"slack_model.py",-1)),n("button",{class:"cpb",onClick:s[7]||(s[7]=(...p)=>a.copy&&a.copy(...p))},"复制")]),s[38]||(s[38]=l(`<pre><code><span class="kw">import</span> numpy <span class="kw">as</span> np
...
<span class="kw">for</span> T, k <span class="kw">in</span> <span class="fn2">zip</span>(temps, kappas):
    <span class="fn2">print</span>(f<span class="st">&quot;{T:.0f} K: κ = {k:.2f} W/m·K&quot;</span>)</code></pre>`,1))]),s[60]||(s[60]=n("h4",null,"phonopy 计算晶格热导率",-1)),n("div",x,[n("div",z,[s[39]||(s[39]=n("span",{class:"la"},"bash",-1)),n("button",{class:"cpb",onClick:s[8]||(s[8]=(...p)=>a.copy&&a.copy(...p))},"复制")]),s[40]||(s[40]=n("pre",null,[n("code",null,[n("span",{class:"cm"},"# 使用 phonopy 计算热导率（BTE 方法）"),t(`
`),n("span",{class:"fn2"},"phonopy"),t(` --mesh="20 20 20" --tprop --fc DispFC

`),n("span",{class:"cm"},"# 或使用 phono3py 计算三声子散射"),t(`
`),n("span",{class:"fn2"},"phono3py"),t(' --mesh="20 20 20" --tprop')])],-1))]),s[61]||(s[61]=n("h3",null,"8. ZT 值计算",-1)),n("div",V,[n("div",Z,[s[41]||(s[41]=n("span",{class:"la"},"python",-1)),s[42]||(s[42]=n("span",{class:"fn"},"calculate_ZT.py",-1)),n("button",{class:"cpb",onClick:s[9]||(s[9]=(...p)=>a.copy&&a.copy(...p))},"复制")]),s[43]||(s[43]=l(`<pre><code><span class="kw">import</span> numpy <span class="kw">as</span> np
<span class="kw">import</span> matplotlib.pyplot <span class="kw">as</span> plt
...
<span class="fn2">print</span>(f<span class="st">&quot;最佳 ZT: {max(max_ZT):.2f} at {best_T} K&quot;</span>)</code></pre>`,1))]),s[62]||(s[62]=l('<h3>9. 常见热电材料</h3><table class="tb"><thead><tr><th>材料</th><th>类型</th><th>最佳温度</th><th>ZT 峰值</th><th>应用</th></tr></thead><tbody><tr><td>Bi₂Te₃</td><td>窄带隙半导体</td><td>300-400 K</td><td>~1.0</td><td>室温制冷</td></tr><tr><td>PbTe</td><td>IV-VI 化合物</td><td>600-900 K</td><td>~2.0</td><td>中温发电</td></tr><tr><td>SnSe</td><td>层状材料</td><td>700-900 K</td><td>~2.6</td><td>高温发电</td></tr><tr><td>Mg₂Si</td><td>硅化物</td><td>500-800 K</td><td>~1.3</td><td>汽车废热</td></tr><tr><td>Half-Heusler</td><td>金属间化合物</td><td>700-1000 K</td><td>~1.5</td><td>高温发电</td></tr></tbody></table><h3>10. 提高 ZT 的策略</h3><div class="db"><div class="db-t">优化热电性能的方法</div><h4>1. 增大功率因子 S²σ</h4><ul><li>优化载流子浓度（通常 10<sup>19</sup>-10<sup>21</sup> cm⁻³）</li><li>能带工程：增大能带有效质量</li><li>能量过滤效应</li><li>共振能级掺杂</li></ul><h4>2. 降低热导率 κ</h4><ul><li>纳米结构化：增加声子散射</li><li>点缺陷散射：合金化、掺杂</li><li>界面散射：纳米复合材料</li><li>本征低热导率材料：重元素、复杂结构</li></ul><h4>3. 能带收敛</h4><ul><li>多能谷材料：增大谷简并度</li><li>温度诱导能带收敛</li><li>压力诱导能带收敛</li></ul></div><h3>11. 完整计算脚本</h3>',5)),n("div",q,[n("div",D,[s[44]||(s[44]=n("span",{class:"la"},"bash",-1)),s[45]||(s[45]=n("span",{class:"fn"},"thermoelectric_workflow.sh",-1)),n("button",{class:"cpb",onClick:s[10]||(s[10]=(...p)=>a.copy&&a.copy(...p))},"复制")]),s[46]||(s[46]=l(`<pre><code><span class="kw">#!/bin/bash</span>
...
<span class="fn2">echo</span> <span class="st">&quot;=== 计算完成 ===&quot;</span></code></pre>`,1))]),s[63]||(s[63]=n("h3",null,"12. 注意事项",-1)),s[64]||(s[64]=n("div",{class:"ib warn"},[n("strong",null,"重要提醒："),n("ul",null,[n("li",null,"热电计算需要密集 K 点（20×20×20 或更高）"),n("li",null,"重元素（Bi, Pb, Te 等）通常需要考虑自旋轨道耦合"),n("li",null,"BoltzTraP 计算需要较大内存"),n("li",null,"晶格热导率计算需要高精度的力常数"),n("li",null,"ZT 的准确度取决于所有参数的准确度")])],-1))])}const G=i(f,[["render",W]]);export{G as default};
